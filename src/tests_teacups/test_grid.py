...
class TestSphereFibonacciGridPoints:
    def setup_method(self):
        ...
        self.sphere = grid.sphere_fibonacci_grid_points(self.npoints, hemisphere=False)
...
class TestSopheGrid:
    def setup_method(self):
        self.grid_size = 30
        self.theta, self.phi, self.weights = grid.sophe_grid(self.grid_size, "C1")
